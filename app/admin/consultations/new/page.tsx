  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (error) {
      ...
      if (error.code === "23505") {
        ...
        setMessage("Something went wrong while saving the consultation.");
      }
        ...
        >
          <div>
            ...
            <input
              ...
              placeholder="e.g. 60-minute Online Advice Call"
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="A short description of what this consultation includes..."
              className="w-full rounded-2xl border border-black/10 px-4 py-3 outline-none focus:border-[#527A5A]"
            />
          </div>
          ...
          <label className="flex cursor-pointer items-center gap-3">
            ...
            <span>
              ...
              <span className="text-sm text-[#6b746b]">
                Active consultations can be shown to customers on the booking page.
              </span>
            </span>
          </label>
